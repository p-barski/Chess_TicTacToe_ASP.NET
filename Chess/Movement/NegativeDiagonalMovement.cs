...
{
	///<summary>
	///Responsible for calculating negative diagonal move of a bishop and a queen.
	///</summary>
	public class NegativeDiagonalMovement : IMovement
	{
		private const int boardSize = 8;
		private readonly IChessBoard chessBoard;
		public NegativeDiagonalMovement(IChessBoard chessBoard)
		{
